...
router.post('/', async (req, res) => {
  ...
  Debug(`Game received post:: ${JSON.stringify(req.body, null, 2)}`)
...
router.put('/:id', async (req, res) => {
  ...
  Debug(`game :: ${JSON.stringify(req.body.board, null, 2)}`)
  Debug(`sent back :: ${{ message: "Game successfully updated", _id: game._id }}`)
})
